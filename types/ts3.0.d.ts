...
interface CompilationSelectorCreator {
  ...
  /* one selector, four compilation */
  <S1, R1, CS1, CP1, CR1, CS2, CP2, CR2, CS3, CP3, CR3, CS4, CP4, CR4, T>(
    selectors: [Selector<S1, R1>],
    compilationSelectors: [
      ParametricSelector<CS1, CP1, CR1>,
      ParametricSelector<CS2, CP2, CR2>,
  ...
  <S1, P1, R1, CS1, CP1, CR1, CS2, CP2, CR2, CS3, CP3, CR3, CS4, CP4, CR4, T>(
    selectors: [ParametricSelector<S1, P1, R1>],
    compilationSelectors: [
      ParametricSelector<CS1, CP1, CR1>,
      ParametricSelector<CS2, CP2, CR2>,
  ...
  /* one selector, fourteen compilations */
  <
    S1,
    R1,
    CS1,
  ...
  >(
    ...
    compilationSelectors: [
      ...
      ParametricSelector<CS12, CP12, CR12>,
      ParametricSelector<CS13, CP13, CR13>,
      ParametricSelector<CS14, CP14, CR14>
    ],
    combiner: (state: S1, res1: R1) => T,
    equalityFn?: EqualityFn<T>
  ): OutputSelector<S1, T, (state: S1, res1: R1) => T>
  ...
  /* one selector, fifteen compilations */
  <
    S1,
    R1,
    CS1,
  ...
  >(
    ...
    compilationSelectors: [
      ...
      ParametricSelector<CS13, CP13, CR13>,
      ParametricSelector<CS14, CP14, CR14>,
      ParametricSelector<CS15, CP15, CR15>
    ],
    combiner: (state: S1, res1: R1) => T,
    equalityFn?: EqualityFn<T>
  ): OutputSelector<S1, T, (state: S1, res1: R1) => T>
  ...
  /* one selector, sixteen compilations */
  <
    S1,
    R1,
    CS1,
  ...
  >(
    ...
    compilationSelectors: [
      ...
      ParametricSelector<CS14, CP14, CR14>,
      ParametricSelector<CS15, CP15, CR15>,
      ParametricSelector<CS16, CP16, CR16>
    ],
    combiner: (state: S1, res1: R1) => T,
    equalityFn?: EqualityFn<T>
  ): OutputSelector<S1, T, (state: S1, res1: R1) => T>
  ...
  /* five selectors, two compilation */
  <S1, S2, S3, S4, S5, R1, R2, R3, R4, R5, CS1, CP1, CR1, CS2, CP2, CR2, T>(
    selectors: [
      Selector<S1, R1>,
      Selector<S2, R2>,
      Selector<S3, R3>,
